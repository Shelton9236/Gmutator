...
/*local*/ const std::vector<int> dataFormatLength = { 0, 1, 1, 2, 4, 8, 1, 1, 2, 4, 8, 4, 8 };
...
public:
	/*local*/ int colorId;
	/*local*/ int colorSelect;
	/*local*/ DWORD clr;
	/*local*/ std::vector<DWORD> jetMap;
	/*local*/ std::string CameraMake;
	/*local*/ std::string CameraModel;
	/*local*/ std::string stack_IFD_dirtype;
	/*local*/ ubyte DHTLevel;
	/*local*/ ubyte DQTLevel;
	/*local*/ byte colorFlag;
